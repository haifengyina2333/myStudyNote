...
<div class="header">
        <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="./BorrowBook.php">借书</a></li>
    ...
    <div class="CoreContent">
        ...
        <table class="table">
            ...
            while ($rows = mysqli_fetch_assoc($res)) {
                ...
                echo '<td><a href="BorrowBookGo.php?BookId=' . $rows['BookId'] . '">加入库 </a>';
                echo '</tr>';
            }
            ...
            ?>
            <a class="go" href="BorrowBook.php?page=1">首页</a>
            <a class="go" href="BorrowBook.php?page=<?php echo $prev; ?>">上一页</a>
            <span>
                <?php echo $page ?>
                /
                <?php echo $pageCount ?>
            </span>
            <a class="go" href="BorrowBook.php?page=<?php echo $next; ?>">下一页</a>
            <a class="go" href="BorrowBook.php?page=<?php echo $pageCount; ?>">尾页</a>
    </div>
