...
<div class="header">
    ...
    <div class="CoreContent">
        ...
        <table class="table">
            ...
            $sql = "select * from Books limit " . $offset . ',' . $num;
            ...
            while ($rows = mysqli_fetch_assoc($res)) {
                ...
                echo '<td style=" font-size: 14px; ">' . $rows['BookAuthor'] . '</td>';
                ...
                //                            带走这个 ID
                echo '<td><a href="BookModify.php?id=' . $rows['id'] . '">修改 </a>/ <a href="BookDelete.php?id=' . $rows['id'] . '">删除</a></td>';
                echo '</tr>';
            }
            ...
            ?>
            <a class="go" href="BookAdmin.php?page=1">首页</a>
            <a class="go" href="BookAdmin.php?page=<?php echo $prev; ?>">上一页</a>
            <span>
                <?php echo $page ?> 
                /
                <?php echo $pageCount ?>
            </span>
            <a class="go" href="BookAdmin.php?page=<?php echo $next; ?>">下一页</a>
            <a class="go" href="BookAdmin.php?page=<?php echo $pageCount; ?>">尾页</a>
            <p></p>
            <a class="go" href="BookAdd.php">添加图书</a>
    </div>
